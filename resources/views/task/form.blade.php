<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('dueDate') }}
            {{ Form::text('dueDate', $task->dueDate, ['class' => 'form-control' . ($errors->has('dueDate') ? ' is-invalid' : ''), 'placeholder' => 'Duedate']) }}
            {!! $errors->first('dueDate', '<div class="invalid-feedback">:message</div>') !!}
        </div>
